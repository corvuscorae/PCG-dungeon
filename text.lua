-- add index to prevent double adding to active
local objective_map = {
    nervous = {
        why = {
            text = "Why is he nervous?",
            resolution_at = {18},
            index = 1
        }
    },
    old_man = {
        who = {
            text = "Who is the old man?",
            resolution_at = {2}, -- indeces where this question is answered
            index = 2
        },
        what_happened = {
            text = "What happened to the old man?",
            resolution_at = {4,12},
            index = 3
        },
        spot = {
            text = "What is the spot that he is viewing?",
            resolution_at = {2, 4, 9, 12},
            index = 4
        }
    },
    murder = {
        plan = {
            text = "How did he prepare?",
            resolution_at = {4},
            index = 5
        },
        how = {
            text = "How did he do it?",
            resolution_at = {12},
            index = 6
        },
        why = {
            text = "Why did he do it?",
            resolution_at = {2},
            index = 7
        },
        get_away = {
            text = "Does he get away with murder?",
            resolution_at = {19},
            index = 8
        }
    },
    room = {
        who = {
            text = "Whose room is he in?",
            resolution_at = {4, 5, 6, 8, 12},
            index = 9
        },
        why = {
            text = "Why is he in the room?",
            resolution_at = {4, 12},
            index = 10
        },
    },
    eye = {
        who = { 
            text = "Whose eye is he seeing?",
            resolution_at = {2, 4, 10, 12},
            index = 11
        }
    },
    corpse = {
    ...
    officers = {
        why = {
            text = "Why are the officers at his house?",
            resolution_at = {15},
            index = 14
        }
    },
    noise = {
        what = {
            text = "What does he hear?",
            resolution_at = {19},
            index = 15
        },
        who = {
            text = "Whose heart does he hear?",
            resolution_at = {11, 12},
            index = 16
        }
    }
...
local tell_tale_heart = {
    {
        ...
        index = {1},
        objectives =  {objective_map.nervous.why},
    },
    {
        ...
        index = {2}, 
        objectives =  {objective_map.old_man.what_happened},
    },
    {
        text = "Now this is the point. You fancy me mad. Madmen know nothing. But you should have seen me. You should have seen how wisely I proceeded--with what caution--with what foresight--with what dissimulation I went to work!", 
        index = {3},
        objectives =  {objective_map.murder.plan},
    },
    {
        text = "I was never kinder to the old man than during the whole week before I killed him. And every night, about midnight, I turned the latch of his door and opened it--oh, so gently! And then, when I had made an opening sufficient for my head, I put in a dark lantern, all closed, closed, so that no light shone out, and then I thrust in my head. Oh, you would have laughed to see how cunningly I thrust it in! I moved it slowly--very, very slowly, so that I might not disturb the old man's sleep. It took me an hour to place my whole head within the opening so far that I could see him as he lay upon his bed. Ha!--would a madman have been so wise as this? And then, when my head was well in the room, I undid the lantern cautiously--oh, so cautiously--cautiously (for the hinges creaked)--I undid it just so much that a single thin ray fell upon the vulture eye. And this I did for seven long nights--every night just at midnight--but I found the eye always closed; and so it was impossible to do the work; for it was not the old man who vexed me, but his Evil Eye. And every morning, when the day broke, I went boldly into the chamber, and spoke courageously to him, calling him by name in a hearty tone, and inquiring how he had passed the night. So you see he would have been a very profound old man, indeed, to suspect that every night, just at twelve, I looked in upon him while he slept.", 
        index = {4},
        objectives =  {objective_map.old_man.who, objective_map.murder.how},
    },
    {
        ...
        index = {5},
        objectives =  {objective_map.room.who, objective_map.room.why},
    },
    {
        text = "I had my head in, and was about to open the lantern, when my thumb slipped upon the tin fastening, and the old man sprang up in bed, crying out: \"Who\'s there?\"", 
        index = {6},
        objectives =  {objective_map.old_man.who},
    },
    {
    ...
    },
    {
        ...
        index = {8},
        objectives =  {objective_map.old_man.who, objective_map.old_man.what_happened, objective_map.room.why},
    },
    {
        text = "When I had waited a long time, very patiently, without hearing him lie down, I resolved to open a little--a very, very little crevice in the lantern. So I opened it--you cannot imagine how stealthily, stealthily--until, at length, a single dim ray, like the thread of the spider, shot from out the crevice and full upon the vulture eye.", 
        index = {9},
        objectives =  {objective_map.eye.who},
    },
    {
        ...
        index = {10},
        objectives =  {objective_map.old_man.who, objective_map.old_man.what_happened, objective_map.old_man.spot},
    },
    {
        text = "And now--have I not told you that what you mistake for madness is but over-acuteness of the senses?--now, I say, there came to my ears a low, dull, quick sound, such as a watch makes when enveloped in cotton. I knew that sound well too. It was the beating of the old man's heart. It increased my fury, as the beating of a drum stimulates the soldier into courage.", 
        index = {11},
        objectives =  {objective_map.old_man.who, objective_map.old_man.what_happened}
    },
    {
        ...
        index = {12},
        objectives =  {objective_map.old_man.who, objective_map.murder.why, objective_map.murder.plan},
    },
    {
        text = "If still you think me mad, you will think so no longer when I describe the wise precautions I took for the concealment of the body. The night waned, and I worked hastily, but in silence. First of all I dismembered the corpse. I cut off the head and the arms and the legs.", 
        index = {13},
        objectives =  {objective_map.corpse.who},
    },
    {
        ...
        index = {14},
        objectives =  {objective_map.corpse.who, objective_map.murder.how, objective_map.murder.why},
    },
    {
        ...
        index = {15},
        objectives =  {objective_map.shriek.who},
    },
    {
        ...
        index = {16},
        objectives =  {objective_map.corpse.who, objective_map.old_man.who, objective_map.old_man.what_happened},
    },
    {
        ...
        index = {17},
        objectives =  {objective_map.nervous.why, objective_map.officers.why, objective_map.noise.what},
    },
    {
    ...
    },
    {
        ...
        index = {19},
        objectives =  {objective_map.noise.who},
    }
}
